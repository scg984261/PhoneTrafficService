# Run the Installer.
msiexec.exe /i PhoneTrafficService-Release-x86-1.0.0.4.msi SP_RUNMODE="HUDSON_HOUSE" SP_INCOMING_PATH="E:\INCOMING.CSV" SP_SPREADSHEET_PATH=`"C:\Share\General\Telephone System\HH Phone Numbers Allocated.xls`" /quiet /passive /norestart
