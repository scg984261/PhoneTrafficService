...
msiexec.exe /i PhoneTrafficService-Release-x86-1.0.0.4.msi SP_RUNMODE="ALBANY_HOUSE" SP_INCOMING_PATH="C:\ELEPHANT\INCOMING.csv" SP_SPREADSHEET_PATH=`"C:\Share\General\Telephone System\AH Phone Numbers Allocated.xls`" /quiet /passive /norestart
